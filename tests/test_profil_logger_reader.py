...
class TestProfilLoggerReader(unittest.TestCase):
    ...
    def test_simple_filter_by_datetime(self):
        ...
        entries = list(ProfilLoggerReader.filter_by_datetime(
    ...
    def test_find_by_text(self):
        ...
        with mock.patch.object(CSVHandler, "get_base_form", return_value=base_form_0):
            entries = profil_logger_reader.find_by_text(text)
        
        self.assertEqual(
            entries,
            [base_form_0[0], base_form_0[3]]
        )
    ...
    def test_find_by_text_datetime(self):
        ...
        with mock.patch.object(CSVHandler, "get_base_form", return_value=base_form_0):
            entries = profil_logger_reader.find_by_text(text, start_date, end_date)
    ...
    def test_find_by_regex_datetime(self):
        ...
        with mock.patch.object(CSVHandler, "get_base_form", return_value=base_form_0):
            entries = profil_logger_reader.find_by_regex(expr, start_date, end_date)
